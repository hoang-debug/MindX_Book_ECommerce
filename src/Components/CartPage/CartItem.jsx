...
import { choices } from "../../Pages/ProductPage/BookDetails";
          ...
          >
            ...
            >
              ...
              <Typography
                variant="subtitle1"
                component="div"
              >{`by ${details.authors.join(", ")}`}</Typography>
              <Typography style={{ color: "orange" }}>
                ({numberWithCommas(details.price)}đ)
              </Typography>
              <Box
                width="100%"
                position="absolute"
            ...
            >
              <Typography align="right" variant="h6">
                <span className="cart-item-price">{`${numberWithCommas(
