...
import { LineItem, LineRow } from "../../Components/BookPage/useBookSearch";
import Banner from "../../Components/BookPage/Banner";
...
const HomePage = () => {
    ...
    const getBooks = async () => {
      ...
      categories.map(cate => {
        let filtered_books = books.filter(
          book => book.category === cate.idCategory
        );
  ...
  return (
    <div className={classes.root}>
      <Banner
        img_url={
          "https://res.cloudinary.com/ha-noi-science-and-techlonogy-university/image/upload/v1654856935/banner_sach1_p84do2.webp"
        }
      />
